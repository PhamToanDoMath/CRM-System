                ...
                <div class="card mb-3">
                        ...
                        @foreach($inputs as $key => $value)
                            <div class="row mb-4">
                                <div class="col-md-8 input-group mb-3 mt-3">
                                    <span class="input-group-text">Item ID</span>
                                    <input class="form-control" type="number" wire:model="menu_id.{{$value}}">
                                    <span class="input-group-text">Quantity</span>
                                    <input class="form-control" type="number" wire:model="quantity.{{$value}}">
                                </div>
                                <div class="col-md-2">
                    ...
                    <div class="card-footer">
                        <div class="alert alert-info">
                            <strong><h5 class="d-inline">Total</h5></strong> : <span class="float-right">{{$total}}$</span>
                        </div>
                    </div>
                </div>
            </div>
