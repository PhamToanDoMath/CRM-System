                    ...
                    <div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;">
                        <div class="simplebar-content" style="padding: 0px;">
                            ...
                            <li class="nav-group"><a class="nav-link" href="{{route('admin.menu.index')}}">
                                    <svg class="nav-icon">
                                        <use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-dinner')}}">
                                        </use>
                            ...
                            <li class="nav-group"><a class="nav-link" href="{{route('admin.orders.index')}}">
                                    <svg class="nav-icon">
                                        <use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-basket')}}">
                                        </use>
                                    </svg>Orders</a>
                            </li>

                            <li class="nav-title">Manage Vouchers</li>
                            <li class="nav-group"><a class="nav-link" href="{{route('admin.vouchers.index')}}">
                                    <svg class="nav-icon">
                                        <use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-tag')}}">
                                        </use>
                                    </svg>Voucher</a>
                            </li>
                ...
                <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                    <div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;">
                        <div class="simplebar-content" style="padding: 0px;">
                            ...
                            {{-- <li class="nav-title">Manage Menu</li>
                            <li class="nav-group"><a class="nav-link" href="{{route('chef.menu.index')}}">
                                    <svg class="nav-icon">
                                        <use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-dinner')}}">
                                        </use>
                                    </svg>Restaurant Menu</a>
                            ...
                            <li class="nav-title">Manage Orders</li>
                            <li class="nav-group"><a class="nav-link" href="{{route('chef.orders.index')}}">
                                    <svg class="nav-icon">
                                        <use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-basket')}}">
                                        </use>
                                    </svg>Orders</a>
                ...
                <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                    <div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;">
                        <div class="simplebar-content" style="padding: 0px;">
                            ...
                            <li class="nav-title">Manage Orders</li>
                            <li class="nav-group"><a class="nav-link" href="{{route('clerk.orders.index')}}">
                                    <svg class="nav-icon">
                                        <use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-basket')}}">
                                        </use>
                                    </svg>Orders</a>
                            ...
                            <li class="nav-group"><a class="nav-link" href="{{route('clerk.orders.create')}}">
                                <svg class="nav-icon">
