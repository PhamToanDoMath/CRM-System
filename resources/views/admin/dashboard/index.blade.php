    ...
    <div class="row">
        <div class="col-sm-6 col-lg-3">
            <div class="card mb-4 text-white bg-primary-gradient">
                ...
                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                    <canvas class="chart" id="card-chart1" height="70" width="184"
                        style="display: block; box-sizing: border-box; height: 70px; width: 184px;"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card mb-4 text-white bg-info-gradient">
                ...
                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                    <canvas class="chart" id="card-chart2" height="70" width="184"
                        style="display: block; box-sizing: border-box; height: 70px; width: 184px;"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card mb-4 text-white bg-warning-gradient">
                ...
                <div class="c-chart-wrapper mt-3" style="height:70px;">
                    <canvas class="chart" id="card-chart3" height="70" width="216"
                        style="display: block; box-sizing: border-box; height: 70px; width: 216px;"></canvas>
                    <div class="chartjs-tooltip" style="opacity: 0; left: 108px; top: 129.4px;">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card mb-4 text-white bg-danger-gradient">
                ...
                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                    <canvas class="chart" id="card-chart4" height="70" width="184"
                        style="display: block; box-sizing: border-box; height: 70px; width: 184px;"></canvas>
                </div>
            </div>
        </div>
    ...
    {{-- <div class="card mb-4">
        <div class="card-body">
            ...
            <div class="c-chart-wrapper" style="height:300px;margin-top:40px;">
                <canvas class="chart" id="main-chart" height="300" width="904"
                    style="display: block; box-sizing: border-box; height: 300px; width: 904px;"></canvas>
            </div>
        </div>
                            ...
                            <tbody>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-medium-emphasis"><span>New</span> | Registered: Jan 1,
                                            2020</div>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
                                            <use xlink:href="{{asset('vendors/@coreui/icons/svg/brand.svg#cib-cc-mastercard')}}">
                                            </use>
                                        </svg>
                                    </td>
                                    <td>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-medium-emphasis"><span>Recurring</span> | Registered: Jan
                                            1, 2020</div>
                                    </td>
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
                                            <use xlink:href="{{asset('vendors/@coreui/icons/svg/brand.svg#cib-cc-apple-pay')}}">
                                            </use>
                                        </svg>
                                    </td>
                                    <td>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="progress-group mb-4">
                                ...
                                <div class="progress-group-bars">
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-info-gradient" role="progressbar" style="width: 34%"
                            ...
                            <div class="progress-group mb-4">
                                ...
                                <div class="progress-group-bars">
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-info-gradient" role="progressbar" style="width: 56%"
                            ...
                            <div class="progress-group mb-4">
                                ...
                                <div class="progress-group-bars">
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-info-gradient" role="progressbar" style="width: 12%"
                            ...
                            <div class="progress-group mb-4">
                                ...
                                <div class="progress-group-bars">
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-info-gradient" role="progressbar" style="width: 43%"
                                            aria-valuenow="43" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-danger-gradient" role="progressbar"
                                            style="width: 91%" aria-valuenow="91" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="progress-group mb-4">
                                ...
                                <div class="progress-group-bars">
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-info-gradient" role="progressbar" style="width: 22%"
                            ...
                            <div class="progress-group mb-4">
                                ...
                                <div class="progress-group-bars">
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-info-gradient" role="progressbar" style="width: 53%"
                            ...
                            <div class="progress-group mb-4">
                                ...
                                <div class="progress-group-bars">
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-info-gradient" role="progressbar" style="width: 9%"
                                            aria-valuenow="9" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-danger-gradient" role="progressbar"
                                            style="width: 69%" aria-valuenow="69" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="progress-group">
                                ...
                                <div class="progress-group-bars">
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-success-gradient" role="progressbar"
                                            style="width: 56%" aria-valuenow="56" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="progress-group">
                                ...
                                <div class="progress-group-bars">
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-success-gradient" role="progressbar"
                                            style="width: 8%" aria-valuenow="8" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                            </div>
